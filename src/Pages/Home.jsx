...
const WORDS = ["Computer Science Student", "Tech Enthusiast","FreeLancer"];
const TECH_STACK = ["MERN" , "JAVA", "Javascript", "Node.js", "Tailwind", "SQL"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/abhishek-7081" },
  { icon: Linkedin, link: "www.linkedin.com/in/abhishek-tripathi-84b998316" },
  { icon: Instagram, link: "https://www.instagram.com/abhishek.tripathi.01/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  I am a Computer Science student, tech enthusiast, had done multiple freelancing projecta and have experience to work in a Team.
                </p>
